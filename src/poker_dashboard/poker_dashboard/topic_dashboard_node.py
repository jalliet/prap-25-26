...
class DashboardWidget(QWidget):
    ...
    def create_cartesian_tab(self):
        ...
        defaults = [0.3, 0.0, 0.2, 0.0, 0.0, 10.0]
    ...
    def create_joint_tab(self):
        ...
        upper = [1.91986, 0.17453, 3.14159, 1.65806, 2.79253, 1.74533]
        lower = [-1.91986, -3.14159, -0.17453, -1.65806, -2.79253, -0.174533]
        ...
        for i in range(6):
            ...
            upper_slide = int(upper[i]*100)
            lower_slide = int(lower[i]*100)
            slider.setRange(lower_slide, upper_slide) 
            slider.setValue(0)
            
            spin = QDoubleSpinBox()
            spin.setRange(lower[i], upper[i])
